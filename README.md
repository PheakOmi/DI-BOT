...
- Navigate to `AUTH_TESTING_BOT` folder
- Select `AUTH_TESTING_BOT.bot` file
...
msbot clone services --name "AUTH_TESTING_BOT" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
